...
object ProtocolInfo {
    ...
    const val SERVER_POST_MOVE_POSITION_PACKET = 16
    ...
    const val POSITION_TRACKING_DB_SERVER_BROADCAST_PACKET = 153
    const val POSITION_TRACKING_DB_CLIENT_REQUEST_PACKET = 154
    ...
    const val AGENT_ANIMATION_PACKET = 304
    const val REFRESH_ENTITLEMENTS_PACKET = 305
    const val PLAYER_TOGGLE_CRAFTER_SLOT_REQUEST_PACKET = 306
