...
data class ItemStackRequest(
    ...
    companion object : ProtoCodec<ItemStackRequest> {
        override fun serialize(
            ...
            ProtoLE.Int.serialize(value.textProcessingEventOrigin?.ordinal ?: -1, stream)
        }
        ...
        override fun deserialize(stream: Source): ItemStackRequest {
            return ItemStackRequest(
                ...
                textProcessingEventOrigin = ProtoLE.Int.deserialize(stream).let {
                    when (it) {
                        -1 -> null
                        else -> FilterCause.entries[it]
                    }
                }
            )
        }
